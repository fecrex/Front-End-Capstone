...
class ReviewList extends React.Component {
  ...
  getReviews = async(inputSort) => {
    try {
      var resp = await axios.post('http://localhost:3000/reviews', { id: this.props.productId[0], sort: inputSort});
      this.setState({
  ...
  getMetaReviewData = async() => {
    try {
      var resp = await axios.post('http://localhost:3000/metareviews', { id: this.props.productId[0]});
      this.setState({
